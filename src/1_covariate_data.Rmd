---
title: "Covariate data for the research paper:"
...
# library(data.table)
# library(zoo)
pkgs<-c("here", "tidyverse", "data.table", "zoo")
...
d <- read_csv(here("data", "adult_age_data_subset.csv")) # importing filtered data from adult_age_basefile.csv -> see file `0_data_subset.Rmd` for subset code.
